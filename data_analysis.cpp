...
Double_t myFunction3(Double_t *x, Double_t *par)
{
    ...
    Double_t result =  I0 * TMath::Power(TMath::Cos(arg1), 2);
    return result;
}
...
void analysis()
{
  ...
  /*  TGraph *g5_100x = new TGraph("Data5_100x.txt", "%lg%lg");
   ...
   /* TGraphErrors *g5R = new TGraphErrors("Data5R.txt", "%lg %lg %*lg %lg");
    ...
    f1d->SetParameters(2.26, 300, 100, 63400);
     TF1 *f1i = new TF1("f1i", myFunction3, 59000, 67900, 4);
    f1i->SetParameters(2.26, 300, 100, 63400);
    ...
    TF1 *f5 = new TF1("f5", myFunction, 59000, 65000, 4);
    ...
    g1R->Fit(f1i, "R");
    g1R->SetTitle("Data1; x [μm]; y [unita' arbitrarie]");
    g1R->Draw();
}
